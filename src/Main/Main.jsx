...
const Main = () => {
  return (
    <main className="flex flex-col items-center text-start  pt-20 ">
      ...
      <div className="w-[70%] h-auto rounded-lg border border-white/10 mt-8 mb-8">
        <div className="flex w-full justify-between rounded border-b border-white/10">
          ...
          <div className="flex items-center gap-2 p-3 sm:p-4 border-white/10">
            ...
            <div className="sm:hidden flex items-center gap-1.5">
              <div className="w-1.5 h-1.5 bg-green-500 rounded-full animate-pulse"></div>
              <span className="text-white/60 text-[10px] whitespace-nowrap">Student</span>
            </div>
          </div>
        </div>
              ...
              <div className="text-white space-y-3">
                ...
                <div className="hidden sm:flex items-center min-w-0">
                  <span className="text-white/60 font-normal text-sm md:text-base whitespace-nowrap overflow-hidden text-ellipsis">
                    ...
                    (by meta)<i className="fa-solid fa-check ms-2 text-green-500/80"></i>
                  </span>
                </div>
                ...
                <div className="flex sm:hidden items-center justify-between min-w-0 gap-2">
                  <span className="text-white/60 font-normal text-xs truncate">
                    <span className="text-white/80 font-semibold">HTML5 </span>
                    <span className="text-[10px] text-white/40">(by UMich)</span>
                    <i className="fa-solid fa-check ms-1 text-green-500/80"></i>
                  </span>
                  <span className="text-white/40 text-[10px] whitespace-nowrap flex-shrink-0">
                    Feb 2024
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                ...
                <div className="flex justify-center sm:justify-start">
                  <Avatar className="border border-white/80 h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 scale-125">
                    <AvatarImage src="./icons/shadcn.png" alt="Shadcn UI" className="grayscale" />
                    <AvatarFallback className="text-[10px] sm:text-xs">SC</AvatarFallback>
                  </Avatar>
                  <Avatar className="border border-white/80 h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 scale-125">
                    <AvatarImage src="./icons/flowbite.png" alt="Flowbite UI" className="grayscale" />
                    <AvatarFallback className="text-[10px] sm:text-xs">FB</AvatarFallback>
                  </Avatar>
                  <Avatar className="border border-white/80 h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 scale-125">
                    <AvatarImage src="./icons/chakra.png" alt="Chakra UI" className="grayscale" />
                    <AvatarFallback className="text-[10px] sm:text-xs">CH</AvatarFallback>
                  </Avatar>
                  <Avatar className="border border-white/80 h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 scale-125">
                    <AvatarImage src="./icons/materialUI.svg" alt="Material UI" className="grayscale" />
                    <AvatarFallback className="text-[10px] sm:text-xs">MU</AvatarFallback>
                  </Avatar>
                </div>
              </div>
            </div>
