  ...
  const projects = [
    {
      ...
      description: "A dynamic web-based chatbot platform that allows users to engage in interactive conversations with the Ollama Large Language Model.",
      image: "./project1.png",
    ...
    },  
    {
      ...
      description: "Telegram chatbot that allows users to engage in interactive conversations with the advanced LLaMA 3 model. Built with the groq-sdk and GROQ API.",
      image: "./project1.png",
    ...
    },  
    {
      ...
      description: "A fully responsive and user-friendly bicycle rental platform designed to streamline the process of renting bikes online",
      image: "./project1.png",
      tech: [],
            ...
            <div className="hidden sm:flex flex-col items-end">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/40 text-[10px] sm:text-xs md:text-sm">
                  • {projects.filter(p => p.duration === "In Progress").length} In Progress
                </span>
              </div>
            </div>
            <div className="sm:hidden flex items-center gap-1.5">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <span className="text-white/60 text-[10px]">{projects.length} Projects</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {projects.map((project, index) => (
                  <Card key={index} className="overflow-hidden bg-[#09090b] border-white/20">
                    <CardContent className="p-4">
                      <div className="flex justify-between items-start mb-2">
                        <CardTitle className="text-xl text-white">{project.title}</CardTitle>
                        <div className="text-right">
                          <p className="text-sm font-medium text-white/80">{project.duration}</p>
